...
function Sleep() {
  ...
  return <h4 style={sleepStyle}>Ami Daily 7-8 Hr Ghumate pochondho kori</h4>;
}
  ...
  return (
    <div className="card">
      ...
      <p>
        ...
        officiis, deserunt hic illo nihil explicabo accusantium libero possimus
        similique molestiae eum consequatur consequuntur itaque aliquid vitae
        consectetur iusto deleniti.
      </p>
    </div>
  );
}
